    ...
    layout: [
      {
        blockType: 'ptHeroSection',
        eyebrow: 'The collection',
        headlineLine1: 'Every oil,',
        headlineLine2: 'one philosophy.',
        headlineItalicWord: 'one philosophy.',
        body: 'Single-origin seeds. Wooden ghanis. Bottled within 72 hours of pressing.',
        primaryCTA: { label: 'Browse all oils', href: '#products' },
        backgroundStyle: 'cream',
      },
      {
        blockType: 'ptFeaturedProducts',
    ...
    layout: [
      {
        ...
        icon: 'cart',
        headline: 'Your cart',
        body: 'This page is rendered dynamically. The cart drawer handles all cart interactions.',
        ctaLabel: 'Continue shopping',
        ctaHref: '/shop',
        note: 'Cart is client-side (Zustand). This page entry exists for CMS navigation / SEO only.',
      },
    ],
  },
    ...
    layout: [
      {
        ...
        icon: 'shield',
        headline: 'Checkout',
        body: 'Secure checkout powered by Razorpay.',
        note: 'Checkout is fully dynamic — this page entry exists for CMS navigation / SEO only.',
      },
    ],
  },
    ...
    layout: [
      {
        ...
        icon: 'user',
        headline: 'My account',
        body: 'Manage your orders, addresses, and preferences.',
        note: 'Account dashboard is rendered dynamically from auth state.',
      },
    ],
  },
