...
export const accountSeedDefaults = {
  account: {
    ...
    // Tabs & headlines — tokens: {firstName} {memberSince} {orders} {bottles} {count}
    tabLabelDashboard: 'Dashboard',
    tabLabelOrders: 'Orders',
    tabLabelSubscriptions: 'Subscriptions',
    tabLabelWishlist: 'Saved bottles',
    overviewEyebrow: 'Member since {memberSince}',
    overviewTitle: 'Hello, ',
    overviewItalic: '{firstName}.',
    ordersEyebrow: '{orders} lifetime · {bottles} bottles',
    ordersTitle: 'Your ',
    ordersItalic: 'orders.',
    subsEyebrowActive: '{count} on your shelf · saving 15% per delivery',
    subsEyebrowEmpty: 'Save 15% on every delivery',
    subsTitle: 'Your ',
    subsItalic: 'shelf.',
    wishlistEyebrow: 'Saved for later',
    wishlistTitle: 'Bottles you ',
    wishlistItalic: 'noted.',
    // Dashboard
    ...
    onItsWayHeading: 'On its way',
    // Subscriptions
    bandShelfLabel: 'On your shelf',
    bandSpentLabel: 'Spent on subscriptions',
    bandSavedLabel: 'Saved at 15% off',
    addSubscriptionLabel: '+ Add a subscription',
    shelfHeading: 'Your shelf',
    subscribedChipLabel: 'Subscribed',
    emptyShelfMessage:
      'Nothing on your shelf yet. Choose “Subscribe & save” on any oil to get 15% off every delivery.',
    browseOilsLabel: 'Browse oils',
    shelfFootnote:
    ...
    // Wishlist
    emptyWishlistMessage: 'Nothing saved yet. Tap the heart on any bottle to keep it here.',
    browseCollectionLabel: 'Browse the collection',
    // Sidebar teaser
    teaserEnabled: true,
    teaserEyebrow: 'Subscribe & save',
    teaserTitle: 'Never run out.',
    teaserBody: '15% off every delivery · pause or cancel anytime.',
    teaserCtaLabel: 'Browse oils',
    teaserCtaHref: '/shop',
  },
} as const
