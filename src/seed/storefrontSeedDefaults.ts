...
export const cartSeedDefaults = {
  ...
  checkout: {
    ...
    leaveAtDoorLabel: "Leave at the door if I'm not home",
    deliveryMethods: [
...
export const accountSeedDefaults = {
  account: {
    ...
    // Addresses (saved-address book + checkout picker)
    addressesTitle: 'Addresses',
    addressesSubtitle: 'Save your delivery and billing addresses for faster checkout.',
    addressesCardTitle: 'Addresses',
    manageAddressesLabel: 'Manage',
    addAddressLabel: 'Add address',
    addFirstAddressLabel: 'Add your first address',
    editAddressLabel: 'Edit',
    deleteAddressLabel: 'Delete',
    saveAddressLabel: 'Save address',
    cancelLabel: 'Cancel',
    setDefaultShippingLabel: 'Set as default shipping',
    setDefaultBillingLabel: 'Set as default billing',
    defaultShippingBadge: 'Default shipping',
    defaultBillingBadge: 'Default billing',
    billingSameLabel: 'Billing address is the same as my shipping address',
    emptyAddressesMessage: "You haven't saved any addresses yet.",
    deleteAddressConfirm: 'Remove this address from your account?',
    newAddressFormTitle: 'New address',
    editAddressFormTitle: 'Edit address',
    fieldLabelNickname: 'Nickname (optional)',
    fieldLabelFullName: 'Full name',
    fieldLabelPhone: 'Phone',
    fieldLabelLine1: 'Address line 1',
    fieldLabelLine2: 'Address line 2 (optional)',
    fieldLabelLandmark: 'Landmark (optional)',
    fieldLabelCity: 'City',
    fieldLabelState: 'State',
    fieldLabelPincode: 'Pincode',
    fieldLabelCountry: 'Country',
    checkoutUseSavedLabel: 'Use a saved address',
    checkoutUseNewLabel: '+ Use a new address',
    navItems: [
...
export const storefrontSeedDefaultsMerged = {
  ...
  checkout: cartSeedDefaults.checkout,
